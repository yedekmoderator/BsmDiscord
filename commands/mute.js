...
exports.run = (client, message, args) => {
  ...
  if (!muteRole) return message.reply('I cannot find a mute role, Please create a role named "Muted"').catch(console.error);
  ...
  message.channel.send(':white_check_mark: Success! I\'ve logged the mute in mod-logs. And if the person is not muted dont blam me as you need to set the permissions for the muted role for each channel.')
